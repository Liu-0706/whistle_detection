...
with tf.device('/GPU:0'):
    model.fit(X_scaled, y, batch_size=16, epochs=20, validation_split=0.2, callbacks=[callback], class_weight={0:1.0, 1:2.0})
...
# === 1. 扫描所有模型文件 ===
model_dir = r"D:\Desk\whistle_detection\model"
